...
namespace SmartHub.Application.UseCases.PluginAdapter.Host
{
	...
	public class PluginHostService<T> : IPluginHostService<T> where T: class
	{
		...
		private Dictionary<string, T> PluginDictionary { get; set; }
		...
		// public PluginHostService(IPluginLoadService<ILight> lightLoader, IPluginLoadService<IDoor> doorLoader)
		// {
